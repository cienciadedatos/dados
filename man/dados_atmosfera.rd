...
\format{Um data.frame com 41472 linhas e 11 colunas
\describe{
\item{latitude}{Localização da medição. Grade espacial de 24 por 24 pontos de coleta, uniformemente espaçada, desde a longitude 113.80W à 56.20W, e latitude 36.2N à 21.2S.}
\item{longitude}{Localização da medição. Grade espacial de 24 por 24 pontos de coleta, uniformemente espaçada, desde a longitude 113.80W à 56.20W, e latitude 36.2N à 21.2S.}
...
\item{temp_superficie}{Temperatura média mensal baseada na energia emitida da superfície da Terra em condições de céu claro (em K).}
\item{temperatura}{Temperatura média mensal do ar perto da superfície da Terra (en K).}
\item{pressao}{Pressão média mensal da superfície atmosférica num determinado local na superfície da Terra (em mbar).}
\item{ozonio}{Média mensal do total de ozônio na coluna atmosférica (em Dobsons).}
