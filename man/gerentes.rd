...
\item{ano}{Ano}
\item{id_equipe}{ID da equipe (factor)}
\item{id_liga}{ID da liga (factor)}
...
\item{jogador_gerente}{Tem valor 'S' (sim) para jogadores que foram jogadores e gerentes de equipe por uma temporada e 'N' (não) caso contrário (factor).}
}}
